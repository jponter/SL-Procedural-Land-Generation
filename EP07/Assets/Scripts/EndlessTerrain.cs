...
public class EndlessTerrain : MonoBehaviour
{
    ...
    public class TerrainChunk
    {
        ...
        public void UpdateTerrainChunk()
        {
            if (mapDataReceived)
            {
                float viewarDstFromNearestEdge = Mathf.Sqrt(bounds.SqrDistance(viewerPosition));
                bool visible = viewarDstFromNearestEdge <= maxViewDist;
                ...
                if (visible)
                {
                    ...
                    {
                        if (viewarDstFromNearestEdge > detailLevels[i].visibleDstThreshold)
                        {
                            lodIndex = i + 1;
                        }
                        else
